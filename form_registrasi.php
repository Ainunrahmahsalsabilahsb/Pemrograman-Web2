                ...
                <div class="col-8">
                    ...
                    <?php foreach ($skills as $key => $value) { ?>
                        ...
                        <div class="custom-control custom-checkbox custom-control-inline">
                            <input name="skill[]" id="skill_0" type="checkbox" class="custom-control-input" value="<?= $key; ?>">
                            <label for="skill_0" class="custom-control-label"><?=$key; ?></label>
                        </div>
        ...
        <table class="table table-bordered">
            ...
            ?>
                <tr>
                    ...
                    <td><?= $domisili; ?></td>
                    <td><?= $prodi; ?></td>
                    <td><?php foreach ($skills_user as $skill){echo $skill;}; 
                    ?>
                    </td>
            </tr>
